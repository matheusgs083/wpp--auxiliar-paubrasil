...
class RegisteredEndpointsSmokeTest(unittest.TestCase):
    ...
    def make_deps(self) -> dict[str, Any]:
        ...
        return {
            ...
            "relatorio_03114902_import_service": None,
    ...
    def endpoint_cases(self) -> list[EndpointCase]:
        ...
        return [
            ...
            EndpointCase("GET", "/admin/conferencia", expected_status=303),
            ...
            EndpointCase("GET", "/api/admin/conferencia/mapas?data=2026-08-24"),
            EndpointCase("GET", "/api/admin/conferencia/garrafeiras?data=2026-08-24"),
            EndpointCase("GET", "/api/admin/conferencia/produtos?search=skol"),
            EndpointCase("GET", "/api/admin/conferencia/mapas/1"),
            EndpointCase("POST", "/api/admin/conferencia/mapas/1/contagens", kwargs={"json": {"counts": []}}),
            ...
            EndpointCase(
                ...
                kwargs={
                    ...
                    "json": {
                        ...
                        "file_base64": "TWFwYTtEYXRhCjE7MjQvMDgvMjAyNgo=",
                    },
                },
            ),
            EndpointCase(

...
def _register_admin_conferencia_routes(app: FastAPI, *, deps: dict[str, Any]) -> None:
    app.include_router(
        create_admin_conferencia_router(
            ...
            create_conferencia_mapa=deps["create_conferencia_mapa"],

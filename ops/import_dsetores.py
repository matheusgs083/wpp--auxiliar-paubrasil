...
def main() -> None:
    ...
    try:
        ...
        refresh_result = dclientes_service.refresh_latest_view()
        print(json.dumps({"mode": "refresh_dclientes_view", **refresh_result}, ensure_ascii=False, indent=2))
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Analisa e importa o CSV dSetores para PostgreSQL, criando as chaves filial_setor, filial_gv e filial_dc."
    )
    parser.add_argument(
        "file_path",
        nargs="?",
